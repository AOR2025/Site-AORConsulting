...
<div class="wp-block-group aor-header-inner aor-shell">
	...
	<!-- wp:navigation {"overlayMenu":"mobile","className":"aor-navigation","layout":{"type":"flex","justifyContent":"right"}} -->
		<!-- wp:navigation-link {"label":"Expertises","url":<?php echo wp_json_encode( aor_consulting_page_url( 'expertises' ) ); ?>,"kind":"custom"} /-->
		<!-- wp:navigation-link {"label":"Notre approche","url":<?php echo wp_json_encode( home_url( '/#approche' ) ); ?>,"kind":"custom"} /-->
		<!-- wp:navigation-link {"label":"Formation","url":<?php echo wp_json_encode( aor_consulting_page_url( 'formation-controle-interne', '/#formation' ) ); ?>,"kind":"custom"} /-->
